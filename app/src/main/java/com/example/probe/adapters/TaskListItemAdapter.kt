...
import com.example.probe.activities.TaskListActivity
...
open class TaskListItemAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val layoutParams = LinearLayout.LayoutParams(
            (parent.width * 1.0).toInt(),
            LinearLayout.LayoutParams.WRAP_CONTENT
        )
        // Here the dynamic margins are applied to the view.
        layoutParams.setMargins(0, (15.toDp()).toPx(), 0, (40.toDp()).toPx())
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is MyViewHolder) {
            ...
            holder.itemView.ib_done_task_list_name.setOnClickListener {
                ...
                object : ItemTouchHelper.SimpleCallback(
                    ...
                    override fun clearView(
                        ...
                        if(mPositionDraggedFrom != -1 && mPositionDraggedTo != -1 &&
                            ...
                            holder.itemView.btn_task_update.visibility = View.VISIBLE
                            holder.itemView.btn_task_update.setOnClickListener {
