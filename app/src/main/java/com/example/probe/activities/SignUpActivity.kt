...
class SignUpActivity : BaseActivity() {
    ...
    private fun registerUser(){
        ...
        val phone: Long = et_number.text.toString().toLong()
    ...
    private fun validateForm(name: String, email: String, password: String, phone: Long): Boolean{
        return when{
    ...
    fun userRegisteredSuccess(){
        Toast.makeText(this, "you have successfully registered the email",  Toast.LENGTH_SHORT).show()
        hideProgressDialog()
